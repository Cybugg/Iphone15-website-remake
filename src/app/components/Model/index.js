        ...
        <div className="screen-max-width">
          ...
          <div className="flex flex-col items-center mt-5">
             ...
             {/* The Scene */}
              ...
              {/* wrapper */}
             <div className='overflow-hidden w-full h-[75vh] md:h-[90vh] pointer-events-none '>
       <div className="w-full h-56  relative translate-x-[-50%] flex items-center justify-center" id='iphones' >
